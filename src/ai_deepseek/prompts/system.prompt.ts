...
// TODO: Переделать промпт для анализа разговора в соответствии со схемой Роберта
//  Обязательно узнать что за курс продается, если нет, то указать "курс не определен"
//  Обязательно узнать просит ли клиент возврат, были ли у него возвраты, за какие курсы. Указать 2 поля - Да/нет и Объяснение возврата
